...
export default function ServiceCards() {
  ...
  <div className="row">
    ...
    <img className="services-first-image" src="services-first-stock-photo.webp" width="400px" alt=""></img>
    ...
    <div className="col col-12">
    <img className="services-second-image" src="services-second-stock-photo.webp" width="400px" alt=""></img>
